...
- **마지막 갱신**: 2026-08-27 UTC
- **검증된 도메인**: 16
- **검증된 IP**: 1
- **미검증 도메인**: 0
- **미검증 IP**: 0
- **파일 해시(SHA-256/MD5)**: 8 (최신 스냅샷 기준, APT24/BADAUDIO — 이전 UNC6508 관련 해시 7건은 캠페인이 60일 창을 벗어나 `latest.md`에서는 제외, [`snapshots/2026-08-23.md`](snapshots/2026-08-23.md)에 보존)
- **악용 CVE**: 5 (전량 미검증 — 원문 페치 차단으로 검색 스니펫만 확보)
