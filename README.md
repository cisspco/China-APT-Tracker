...
- **마지막 갱신**: 2026-09-02 UTC
- **검증된 도메인**: 21
- **검증된 IP**: 5
- **미검증 도메인**: 0
- **미검증 IP**: 0
- **파일 해시(SHA-256/MD5)**: 14 (최신 스냅샷 기준, APT24/BADAUDIO 8건 + UNC2814/GRIDTIDE 6건 — UNC6508 관련 해시 7건은 캠페인이 60일 창을 벗어나 `latest.md`에서는 제외, [`snapshots/2026-08-23.md`](snapshots/2026-08-23.md)에 보존)
